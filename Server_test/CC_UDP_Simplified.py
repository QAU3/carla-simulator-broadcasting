...
class World(object):
    ...
    def restart(self):
        ...
        # Creates a new instance o Car object. They are stored in list so we can iterat them        
        ...
        #The set the car that the player controls 
    ...
    def destroy_sensors(self):
        #Destroy all our cars from world
...
class Car(object):
    ...
    def destroy_sensors(self):
        self.rgb_observers.sensor.destroy()
        self.rgb_observers=None
...
class RGBObservers(object):
    ...
    def set_sensors(self):
        ...
        lambda image: partial(self.rgb_callback)(image))
        self.sensor=cam1   
    ...
    def send_image(self,image, sock ):
        FS=FrameSegment(sock, self._port)
        try:
            #Fragment the image and multicast it
...
class FrameSegment(object):
    ...
    def udp_frame(self, img):
        ...
        into data segments"""
        ##Here somthing realted w image compression could be done
